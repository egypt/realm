...
export const FilterControlWrapper = ({ children, label }: { children: ReactElement, label: string }) => {
    ...
    return (
        <div className='flex justify-end'>
            <Button ref={buttonRef} leftIcon={<AdjustmentsHorizontalIcon className="w-4" />} buttonVariant='ghost' buttonStyle={{ color: "gray", size: "md" }} onClick={openDialog}>{label}</Button>
